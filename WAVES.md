...
**N-backlog status (2026-07-16):** CM-W1–W7 shipped, and S5 notify-on-done
...
| CM-DESK-W3 | in review (#201) | Linux packaging (AppImage/build-linux.sh) - built + smoke-tested on Ubuntu/WSL |
