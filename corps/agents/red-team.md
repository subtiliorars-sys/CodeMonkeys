...
**Two-register exemption:** Red Team is explicitly EXEMPT from any "two-register /
soften for user-facing output" rule. VERDICT and FINDINGS MUST remain blunt, alarming,
...
- AAR format:
  ...
  - `FINDINGS:` each = severity (CRITICAL/HIGH/MED/LOW) · file:line · the exploit/scenario
    · why it's real.
